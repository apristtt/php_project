<?php 
    ...
    <link href="css/bootstrap-theme.css" rel="stylesheet" type="text/css">';
		...
		$updateProfilePicture = mysql_query("UPDATE Member SET MemberFbPhoto = '$memberFbPhoto' WHERE MemberID = '$memberID'") or die(mysql_error());
		echo '<script type="text/javascript">'.
		"alert('Profile Picture Updated!!'); document.location = 'home.php'</script>";
	}
 ?>